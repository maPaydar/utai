...
fun main(args: Array<String>) {
    ...
    val n1 = Node(s1, n0, Action(0), 0.0)
    val n2 = Node(s2, n0, Action(1), 0.0)

    val n3 = Node(s3, n1, Action(0), 0.0)
    val n4 = Node(s4, n1, Action(1), 0.0)

    val n5 = Node(s5, n2, Action(0), 0.0)
    val n6 = Node(s6, n2, Action(1), 0.0)
